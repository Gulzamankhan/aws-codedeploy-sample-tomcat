...
<head>
    ...
    <title>Bespoke Suits for Dogs! development(A sample app for CodeDeploy)</title>
...
<body role="document">
  ...
  <div class="container theme-showcase" role="main">
    ...
    <% } %>
    <div class="jumbotron">
      <h1>Bespoke Suits for Dogies</h1>
      <p><i>Why can't your canine companion be classy too? WellDone</i></p>
    </div>
